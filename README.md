# Yönetim Paneli (Örnek)

<div align="center">

[![GitHub](https://img.shields.io/badge/GitHub-Bilgisayar-Kavramlari-Toplulugu-181717?style=flat-square&logo=github)](https://github.com/Bilgisayar-Kavramlari-Toplulugu/management)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg?style=flat-square)](LICENSE)

**Part of [Yönetim Paneli](docs/Project-Definition.md)**
...
> **ÖNEMLİ:** Bu repository **Yönetim Paneli** projesinin bir parçasıdır. Proje hakkında detaylı bilgi için [`docs/Project-Definition.md`](docs/Project-Definition.md) dosyasına bakın.
...
```bash
git clone https://github.com/Bilgisayar-Kavramlari-Toplulugu/management.git
cd management
...
> **IMPORTANT:** This repository is part of **Yönetim Paneli** project. See [`docs/Project-Definition.md`](docs/Project-Definition.md) for details.
