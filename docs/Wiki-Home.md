# Yönetim Paneli Projesi Wiki'sine Hoş Geldiniz (Örnek)

<details open> <summary><strong>🇹🇷 Türkçe</strong></summary> <br>

Bu alan, **Yönetim Paneli** projesinin yaşayan dokümantasyon merkezidir. Projenin mimarisi, tasarım kararları ve uzun vadeli bilgileri burada yer alacaktır.

👤 **Proje Lideri:** @hakanceran64  
👥 **Takım:** management[https://github.com/orgs/Bilgisayar-Kavramlari-Toplulugu/teams/management]
---
...
- **[Issue Takip Panosu](https://github.com/Bilgisayar-Kavramlari-Toplulugu/management/issues)**: Mevcut görevleri ve hataları görmek için.
- **[Proje Panosu](https://github.com/Bilgisayar-Kavramlari-Toplulugu/management/projects)**: Projenin genel yol haritasını görmek için.
...
This is the living documentation hub for the **Yönetim Paneli** project. The project's architecture, design decisions, and long-term information will reside here.


👤 **Project Lead:** @hakanceran64  
👥 **Team:** [management](https://github.com/orgs/Bilgisayar-Kavramlari-Toplulugu/teams/management)
